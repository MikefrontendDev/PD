...
class Queueitems_ThemesController extends JO_Action {
	...
	public function editAction() {
		...
		if($request->isPost()) {
			if($request->getPost('submit')) {
				...
				Model_Items::deleteItem($request->getQuery('id'), $request->getParams('message'));
	...
	private function getForm() {
    	...
    	$category = Model_Categories::getParentCategoryByItem($info['id']);
