 ...
 */
class WM_BBCode_ElementNode extends WM_BBCode_Node {
	 ...
	 */
	public function setCodeDefinition( WM_BBCode_CodeDefinition $codeDef ) {
	 ...
	 */
	public function addChild(WM_BBCode_Node $child) {
